...
function App() {
	...
	return <main className="shell">
		...
		{showMunicipality && <MunicipalityOperations token={municipalityToken} onClose={() => setShowMunicipality(false)} onSignOut={municipalitySignOut} onOpenUpdates={() => setShowMunicipalityUpdates(true)} />}
