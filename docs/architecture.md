...
Municipality root assignments expand into selectable descendant scopes at login. For example, a `gauteng` assignment exposes Gauteng, its districts, Johannesburg, Sandton, Ekurhuleni, Pretoria, and other descendants; selecting Sandton narrows the portal while remaining authorized by the Gauteng assignment.
